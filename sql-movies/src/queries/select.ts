import { ACTORS, KEYWORDS, DIRECTORS, GENRES, PRODUCTION_COMPANIES, MOVIES, MOVIE_RATINGS } from "../table-names";
...
export const selectRatingsByUserID = (userId: number): string => {
  return `SELECT user_id, rating FROM ${MOVIE_RATINGS} where user_id = '${userId}'`;
};
